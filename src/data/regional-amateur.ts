...
export const REGIONAL_CLUBS: RegionalClubSeed[] = [
  ...
  R("sanantonio-r1", "San Antonio", "Ranchillos", "Tucumán", "Norte", "1"),
  ...
  R("sanpablo-r2", "San Pablo", "San Pablo", "Tucumán", "Norte", "2"),
  ...
  R("sportivopocitos-r3", "Sportivo Pocitos", "Salvador Mazza", "Salta", "Norte", "3"),
  ...
  R("avenidafc-r4", "Avenida Fútbol Club", "Villa Ángela", "Chaco", "Litoral Norte", "4"),
  R("deportivocomercio-r4", "Deportivo Comercio", "Santa Sylvina", "Chaco", "Litoral Norte", "4"),
  R("sportivocultural-r4", "Sportivo Cultural", "Juan José Castelli", "Chaco", "Litoral Norte", "4"),
  R("unionyfuerza-r4", "Unión y Fuerza", "Corzuela", "Chaco", "Litoral Norte", "4"),
  R("mandiyu-r5", "Mandiyú", "Corrientes", "Corrientes", "Litoral Norte", "5"),
  R("huracancorrientes-r5", "Huracán Corrientes", "Corrientes", "Corrientes", "Litoral Norte", "5"),
  R("union-bellavista-r5", "Unión", "Bella Vista", "Corrientes", "Litoral Norte", "5"),
  R("huracan-goya-r5", "Huracán", "Goya", "Corrientes", "Litoral Norte", "5"),
  R("surubi-r6", "Surubí", "Goya", "Corrientes", "Litoral Norte", "6"),
  R("santalucia-r6", "Santa Lucía", "Santa Lucía", "Corrientes", "Litoral Norte", "6"),
  R("lipton-r6", "Lipton", "Corrientes", "Corrientes", "Litoral Norte", "6"),
  ...
  R("psmfutbol-r3", "PSM Fútbol", "San Lorenzo", "Santa Fe", "Litoral Sur", "3"),
  ...
  R("ciclonracing-r4", "Ciclón Racing", "Santa Fe", "Santa Fe", "Litoral Sur", "4"),
  ...
  R("recreativosanjorge-r5", "Recreativo San Jorge", "Villa Elisa", "Entre Ríos", "Litoral Sur", "5"),
  R("atleticosauce-r5", "Atlético Sauce", "Colón", "Entre Ríos", "Litoral Sur", "5"),
  R("defensoresparana-r6", "Defensores", "Paraná", "Entre Ríos", "Litoral Sur", "6"),
  R("donbosco-parana-r6", "Don Bosco", "Paraná", "Entre Ríos", "Litoral Sur", "6"),
  R("atleticoparana-r6", "Atlético Paraná", "Paraná", "Entre Ríos", "Litoral Sur", "6"),
  R("libertad-parana-r6", "Libertad", "Paraná", "Entre Ríos", "Litoral Sur", "6"),
  ...
  R("laensenada-r2", "La Ensenada", "Quimilí", "Santiago del Estero", "Centro", "2"),
  ...
  R("25demayo-termas-r3", "Atlético 25 de Mayo", "Termas Río Hondo", "Santiago del Estero", "Centro", "3"),
  R("centralargentino-labanda-r3", "Central Argentino", "La Banda", "Santiago del Estero", "Centro", "3"),
  ...
  R("losverdes-elmojon-r4", "Deportivo Los Verdes", "El Mojón", "Santiago del Estero", "Centro", "4"),
  R("sanmartin-elojito-r4", "Atlético San Martín", "El Ojito", "Santiago del Estero", "Centro", "4"),
  R("fida-elarenal-r4", "FIDA", "El Arenal", "Santiago del Estero", "Centro", "4"),
  R("atletico-frias-r5", "Atl. Frías", "Frías", "Santiago del Estero", "Centro", "5"),
  R("sportivoloreto-r5", "Sportivo Loreto", "Loreto", "Santiago del Estero", "Centro", "5"),
  R("unionsantiago-r5", "Unión Santiago", "Santiago del Estero", "Santiago del Estero", "Centro", "5"),
  ...
  R("pacifico-alvear-r1", "Pacífico", "Gral. Alvear", "Mendoza", "Cuyo", "1"),
  R("laconsulta-r2", "La Consulta", "La Consulta", "Mendoza", "Cuyo", "2"),
  R("sancarlos-mendoza-r2", "San Carlos", "Villa San Carlos", "Mendoza", "Cuyo", "2"),
  R("vialidadnacional-r2", "Vialidad Nacional", "Malargüe", "Mendoza", "Cuyo", "2"),
  R("deportivomalargue-r2", "Deportivo Malargüe", "Malargüe", "Mendoza", "Cuyo", "2"),
  R("argentino-mendocino-r3", "Argentino", "San José", "Mendoza", "Cuyo", "3"),
  R("atleticopalmira-r3", "Atl. Palmira", "Palmira", "Mendoza", "Cuyo", "3"),
  R("montecaseros-r3", "Montecaseros", "Montecaseros", "Mendoza", "Cuyo", "3"),
  R("lalibertad-r3", "La Libertad", "Rivadavia", "Mendoza", "Cuyo", "3"),
  ...
  R("defensoresbelgrano-daract-r4", "Defensores de Belgrano", "Justo Daract", "San Luis", "Cuyo", "4"),
  R("alianzafutbolistica-r4", "Alianza Futbolística", "Villa Mercedes", "San Luis", "Cuyo", "4"),
  R("estrellaroja-r5", "Estrella Roja", "Candelaria", "San Luis", "Cuyo", "5"),
  R("latotora-r5", "La Totora", "Candelaria", "San Luis", "Cuyo", "5"),
  R("colocasi-r5", "Colocasi", "San Francisco de Monte de Oro", "San Luis", "Cuyo", "5"),
  ...
  R("companiageneral-r6", "Compañía General", "Salto", "Buenos Aires", "Pampeana Norte", "6"),
  R("defensoresdesalto-r6", "Defensores de Salto", "Salto", "Buenos Aires", "Pampeana Norte", "6"),
  R("atletico9dejulio-r6", "Atlético 9 de Julio", "Chacabuco", "Buenos Aires", "Pampeana Norte", "6"),
  R("sanmartin-chacabuco-r6", "San Martín", "Chacabuco", "Buenos Aires", "Pampeana Norte", "6"),
  R("somisa-r7", "Somisa", "San Nicolás de los Arroyos", "Buenos Aires", "Pampeana Norte", "7"),
  R("atleticoparana-san nicolas-r7".replace(/ /g, "-"), "Atlético Paraná", "San Nicolás", "Buenos Aires", "Pampeana Norte", "7"),
  R("juventud-pergamino-r7", "Juventud", "Pergamino", "Buenos Aires", "Pampeana Norte", "7"),
  ...
  R("deportivonorte-mdq-r3", "Deportivo Norte", "Mar del Plata", "Buenos Aires", "Pampeana Sur", "3"),
  ...
  R("elfortin-olavarria-r5", "El Fortín", "Olavarría", "Buenos Aires", "Pampeana Sur", "5"),
  ...
  R("futbolclub-trenquelauquen-r6", "Futbol Club", "Trenque Lauquen", "Buenos Aires", "Pampeana Sur", "6"),
  R("argentino-25demayo-r6", "Argentino", "25 de Mayo", "Buenos Aires", "Pampeana Sur", "6"),
  R("allboyssantarosa-r7", "All Boys", "Santa Rosa", "La Pampa", "Pampeana Sur", "7"),
  R("atleticosantarosa-r7", "Atl. Santa Rosa", "Santa Rosa", "La Pampa", "Pampeana Sur", "7"),
  R("ferropico-r7", "Ferro Carril Oeste", "General Pico", "La Pampa", "Pampeana Sur", "7"),
  R("allboystrenel-r7", "All Boys", "Trenel", "La Pampa", "Pampeana Sur", "7"),
  ...
  R("atlchimpay-r2", "Atl. Chimpay", "Choele Choel", "Río Negro", "Patagonia", "2"),
  R("deportivodarwin-r2", "Deportivo Darwin", "Lamarque", "Río Negro", "Patagonia", "2"),
  R("deportivobeltran-r2", "Deportivo Beltrán", "Luis Beltrán", "Río Negro", "Patagonia", "2"),
  R("sportsman-choele-r2", "Sportsman Club", "Choele Choel", "Río Negro", "Patagonia", "2"),
  R("radatilly-r3", "Atl. Rada Tilly", "Rada Tilly", "Chubut", "Patagonia", "3"),
  R("huracan-comodoro-r3", "Huracán", "Comodoro Rivadavia", "Chubut", "Patagonia", "3"),
  R("cai-comodoro-r3", "C.A.I", "Comodoro Rivadavia", "Chubut", "Patagonia", "3"),
  R("empleadoscomercio-trelew-r4", "Empleados de Comercio", "Trelew", "Chubut", "Patagonia", "4"),
  R("jjmoreno-r4", "Atlético J.J. Moreno", "Puerto Madryn", "Chubut", "Patagonia", "4"),
  R("deportivoroca-rawson-r4", "Dep. Roca", "Rawson", "Chubut", "Patagonia", "4"),
  R("deportivofontana-r4", "Deportivo Fontana", "Trevelin", "Chubut", "Patagonia", "4"),
  R("deportivescorpion-r5", "Dep. Escorpión F.C.", "Río Gallegos", "Santa Cruz", "Patagonia", "5"),
  R("deportivoesperanza-r5", "Dep. Esperanza", "El Calafate", "Santa Cruz", "Patagonia", "5"),
  R("boxingclub-r5", "Boxing Club", "Río Gallegos", "Santa Cruz", "Patagonia", "5"),
  R("bancruz-r5", "Bancruz", "Río Gallegos", "Santa Cruz", "Patagonia", "5"),
  R("santacruzfc-r5", "Santa Cruz F.C.", "Río Turbio", "Santa Cruz", "Patagonia", "5"),
  R("atleticosanjulian-r5", "Atl. San Julián", "Puerto San Julián", "Santa Cruz", "Patagonia", "5"),
  R("riomayo-r5", "Deportivo Río Mayo", "Río Mayo", "Santa Cruz", "Patagonia", "5"),
  R("camioneros-riogrande-r6", "Camioneros", "Río Grande", "Tierra del Fuego", "Patagonia", "6"),
  R("estrella-austral-r6", "Estrella Austral", "Río Grande", "Tierra del Fuego", "Patagonia", "6"),
  R("sanmartin-tdf-r6", "San Martín", "Río Grande", "Tierra del Fuego", "Patagonia", "6"),
  R("camioneros-ushuaia-r6", "Camioneros", "Ushuaia", "Tierra del Fuego", "Patagonia", "6"),
  R("aatedyc-r6", "AATEDYC", "Ushuaia", "Tierra del Fuego", "Patagonia", "6"),
