...
export const COMPETITIONS: Record<DivisionId, CompetitionRules> = {
  primera_division: {
    ...
    hasZones: true, zones: ["A", "B"], matchesPerTeam: 16,
  ...
  primera_nacional: {
    ...
    matchesPerTeam: 36,
    formatLabel: "2 zonas de 18 · ida y vuelta (34 fechas) + 2 fechas interzonales; final por 1er ascenso y Reducido por 2º ascenso",
    relegation: [
  ...
  primera_b: {
    ...
    matchesPerTeam: 42,
    formatLabel: "22 equipos · todos contra todos, ida y vuelta (42 fechas); campeón + Reducido 2º-9º",
    usesAffiliation: false,
  },
  primera_c: {
    division: "primera_c",
  ...
  regional_federal_amateur: {
    ...
    relegation: [],
    matchesPerTeam: 6,
    formatLabel: "8 regiones geográficas · zonas de 3/4 ida y vuelta · rondas 2-5 + final regional a doble partido · 4 finales nacionales",
    usesAffiliation: false,
  },
  federal_a: {
    division: "federal_a",
