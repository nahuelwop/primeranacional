...
// crowdBand = franja vertical (en coords del canvas) donde va la hinchada procedural, si
// corresponde (evita tapar letras/escudos ya dibujados en la foto).
// crowdOverlay: false = la foto ya trae la multitud integrada, no se agrega nada encima.
...
function CompetitionScorebug({
  ...
  return (
    ...
    >
      ...
      {variant !== "copa_argentina" && <div className="competition-scorebug__period">1T</div>}
    </div>
  );
}
